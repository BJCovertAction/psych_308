...
drop_cols <- unique( c(mid_cols, sen_cols, cat_cols) )
...
So we add delta_anxiety as our primary outcome variable here.
...
augment_dat$delta_anx <- augment_dat$avg_stai_after - augment_dat$avg_stai_before


augment_dat <- augment_dat %>% relocate(c("delta_anx", "avg_stai_after", "avg_stai_before"), .after=pref_dark_dc)
