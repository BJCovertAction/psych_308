...
me_simp_model <- lm(js_cent ~ wp_cent + jv_cent + ja_cent, data = raw_dat)
me_mod_model  <- lm(js_cent ~ wp_cent + jv_cent + pxv_cent + ja_cent + pxa_cent, data = raw_dat)
...
ggplot(me_simp_model,
    ...
    xlab("Theoretical Quantiles") +
    ylab("Standardized Residuals") +
    ggtitle("Normal Q-Q of Main Effects w/ Moderation Model") +
    my_gg_theme
...
model1_def <- '
              ...
              # Covariances: NOTE: Homework picture does not include this, but I am adding it for best practices
              #                    might change my answer from what is expected
              jv_cent ~~ ja_cent
