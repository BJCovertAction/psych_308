...
A researcher was interested in the amount of reading done by graduate students. She recruits forty students and measures their degree program (Group), Gender, and the number of pages read per week. All students in the sample identified as either male or female, thus the gender variable only has two levels.  
