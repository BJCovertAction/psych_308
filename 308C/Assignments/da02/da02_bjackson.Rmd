...
# We'll also create centered datasets here for use later
success_dat_m1$success_cent <- success_dat_m1$success - mean(success_dat_m1$success)
success_dat_m2$success_cent <- success_dat_m2$success - mean(success_dat_m2$success)
...
# SAMPLE CODE for 1 model:

# Define linear model 1: success ~ professionalism, competence
# TODO: Adjust to centered varnames
# success_model_lin_centered <- lm(success ~ profes + comp, data = success_dat)

# Use reg.table method in APA package to generate regression table
# apa.reg.table( success_model_lin_centered, filename="success_reg_to_prof_and_comp.doc", table.number = 2 )

# Define linear model 2: success ~ professionalism, competence, motivation
# TODO: Adjust to centered varnames
# success_model_lin_centered <- lm(success ~ profes + comp + motivation, data = success_dat)

# Use reg.table method in APA package to generate regression table
# apa.reg.table( success_model_lin_centered, filename="success_reg_to_prof_and_comp_and_mot.doc", table.number = 3 )
