...
# (HS graduation times)
this_dat$income_cent     <- this_dat$income - mean(this_dat$income)
this_dat$illiteracy_cent <- this_dat$illiteracy - mean(this_dat$illiteracy)
...
tranistion_mult_regr_ot <- linReg( this_dat,
                                   dep = 'success',
...
tranistion_mult_regr_ot_cent <- linReg( this_dat,
                                        dep = 'success',
...
# OnTime Graduation as Reference. UnCentered.   
tranistion_mult_regr_no <- linReg( this_dat,
                                   dep = 'success',
...
# OnTime Graduation as Reference. Centered.        
tranistion_mult_regr_no_cent <- linReg( this_dat,
                                        dep = 'success',
...
tranistion_mult_regr_ot_ill_02 <- linReg( this_dat,
                                          dep = 'success',
                                          covs = c('income','illiteracy', 'grad_late_refd_to_ontime', 'grad_none_refd_to_ontime'),
                                          blocks = list(
                                                         list( 'grad_late_refd_to_ontime', 'grad_none_refd_to_ontime' ),
...
tranistion_mult_regr_ot_ill_01 <- linReg( this_dat,
                                          dep = 'success',
                                          covs = c('income','illiteracy', 'grad_late_refd_to_ontime', 'grad_none_refd_to_ontime'),
                                          blocks = list(
                                                         list( 'illiteracy' ),  
